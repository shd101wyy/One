...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsLogin_signupJsx = __webpack_require__(168);

	var _componentsInput_areaJsx = __webpack_require__(213);

	var _componentsInput_areaJsx2 = _interopRequireDefault(_componentsInput_areaJsx);

	var _componentsPost_contentJsx = __webpack_require__(214);

	var _componentsPost_contentJsx2 = _interopRequireDefault(_componentsPost_contentJsx);

	var _componentsMarkdown_editorJsx = __webpack_require__(216);

	var _componentsMarkdown_editorJsx2 = _interopRequireDefault(_componentsMarkdown_editorJsx);

	var _componentsMy_topicsJsx = __webpack_require__(217);
	...
	var _componentsFriend_listJsx = __webpack_require__(221);

	var _componentsFriend_listJsx2 = _interopRequireDefault(_componentsFriend_listJsx);

	var _apiUser_apiJs = __webpack_require__(211);
	...
	var _apiSocket_apiJs = __webpack_require__(212);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        this.state.userLoggedIn ? _react2['default'].createElement(_componentsFriend_listJsx2['default'], { app: this }) : null,
	        this.state.userLoggedIn ? _react2['default'].createElement(_componentsHot_topicsJsx2['default'], { app: this }) : null,
	        this.state.userLoggedIn ? _react2['default'].createElement(_componentsMy_topicsJsx2['default'], { app: this }) : null
	      );
	    }
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              signin ? 'Please sign in' : 'Please sign up'
	            ),
	            _react2['default'].createElement(
	              'label',
	            ...
	            _react2['default'].createElement('input', { type: 'email', id: 'inputEmail', className: 'form-control', placeholder: 'Email address', required: '', autofocus: '', onChange: this.inputEmail.bind(this) }),
	            _react2['default'].createElement(
	              'label',
	          ...
	          _react2['default'].createElement(
	            'a',
	            { className: 'switch-panel-btn', onClick: this.toggleSignin.bind(this) },
	            ' ',
	            signin ? '没有账号? 点击我进行注册' : '已经有账号了? 点击我进行登入',
	            ' '
	          ),
	          _react2['default'].createElement(
	            'a',
	            { className: 'close-panel-btn', onClick: this.closePanel.bind(this) },
	            ' 关闭 '
	          )
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createLocation = __webpack_require__(184);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibCreateLocation = __webpack_require__(184);
...
/***/ function(module, exports) {
	...
	var userAPI = {
	  ...
	  deleteTopic: function deleteTopic(userId, topic, callback) {
	    $.ajax('/delete_user_topic', {
	      type: 'POST',
	      dataType: 'json',
	      data: { userId: userId, topic: topic },
	      success: function success(res) {
	        successFn(res, callback);
	      },
	      error: function error(res) {
	  ...
	  _createClass(InputArea, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement('div', { className: 'input-box', 'data-placeholder': userLoggedIn ? this.state.placeholder : "",
	        ...
	        userLoggedIn ? _react2['default'].createElement('span', { className: 'signin-hint' }) : _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'a',
	            { onClick: this.showLoginPanel.bind(this) },
	            ' click me '
	          ),
	          ' to sign in '
	        ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var marked = __webpack_require__(215);
	  ...
	  _createClass(PostContent, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      img.onerror = function () {
	        ...
	        var data = new Identicon(_this.props.postData.userId, 48).toString();
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement('img', { src: this.state.imageSrc, 'data-toggle': 'tooltip', 'data-placement': me ? 'right' : 'left', title: userId, ref: 'profilePic' }),
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'panel' },
	          _react2['default'].createElement('textarea', { className: 'editor', id: 'markdown-editor' }),
	          _react2['default'].createElement('div', { className: 'preview', dangerouslySetInnerHTML: { __html: marked('\n' + this.state.content) } }),
	          _react2['default'].createElement(
	            'button',
	            { className: 'btn cancel-btn', onClick: this.closePanel.bind(this) },
	            ' close '
	          ),
	          _react2['default'].createElement(
	            'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TopicItem = (function (_React$Component) {
	  ...
	  function TopicItem(props) {
	    ...
	    _get(Object.getPrototypeOf(TopicItem.prototype), 'constructor', this).call(this, props);
	  }
	  ...
	  _createClass(TopicItem, [{
	    ...
	    value: function deleteTopic() {
	      ...
	      _apiUser_apiJs2['default'].deleteTopic(window.global.userId, this.props.topic, function (res) {
	        if (res && res.success) {
	          _this.props.app.setState({ userData: res.data });
	        }
	      });
	...
	var MyTopics = (function (_React$Component2) {
	  _inherits(MyTopics, _React$Component2);

	  function MyTopics(props) {
	    _classCallCheck(this, MyTopics);

	    _get(Object.getPrototypeOf(MyTopics.prototype), 'constructor', this).call(this, props);
	  }

	  _createClass(MyTopics, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {}
	  }, {
	    key: 'render',
	    value: function render() {
	      var topics = this.props.app.state.userData.topics;
	      var topicsList = [];

	      if (topics) {
	        for (var i = topics.length - 1; i >= 0; i--) {
	          topicsList.push(_react2['default'].createElement(
	            TopicItem,
	            { key: i, app: this.props.app, topic: topics[i] },
	            ' '
	          ));
	        }
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HotTopics = (function (_React$Component) {
	  _inherits(HotTopics, _React$Component);

	  function HotTopics(props) {
	    _classCallCheck(this, HotTopics);

	    _get(Object.getPrototypeOf(HotTopics.prototype), 'constructor', this).call(this, props);
	    this.state = {
	      hotTopics: []
	    };
	  }

	  _createClass(HotTopics, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      var _this = this;

	      var getHotTopics = function getHotTopics() {
	        $.ajax('/get-hot-topics', {
	          type: 'GET',
	          dataType: 'json',
	          success: function success(res) {
	            if (res && res.success) {
	              ...
	              _this.setState({ hotTopics: res.data });
	            }
	          },
	          error: function error(res) {
	            // do nothing
	    ...
	    key: 'render',
	    value: function render() {
	      var hotTopics = this.state.hotTopics,
	          topicsList = [];
	      if (hotTopics.length) {
	        topicsList = hotTopics.map(function (data, index) {
	          var topic = data[0],
	              hits = data[1];
	          return _react2['default'].createElement(
	            'li',
	            ...
	            _react2['default'].createElement(
	              'span',
	              { className: 'badge ' + (index === 0 ? 'number1' : index === 1 ? 'number2' : '') },
	              hits + ' hits'
	            ),
	            index + 1 + '. ' + topic
	          );
